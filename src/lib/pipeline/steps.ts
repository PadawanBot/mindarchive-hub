...
export const PIPELINE_STEPS: StepDefinition[] = [
  ...
  // ─── Production (14-18) ───
  {
    ...
    order: 14,
    provider: "elevenlabs",
    dependsOn: ["script_refinement", "voice_selection"],
    description: "Generate TTS audio from the refined script using ElevenLabs. The voiceover MP3 is the production clock.",
    skippable: false,
  },
  {
    id: "image_generation",
